...
public class WordCountDriver {
	...
	private static final transient Logger LOG = LoggerFactory.getLogger(WordCountDriver.class);
	...
	public static void main(String[] args) throws Exception {
		...
		properties.load(WordCountDriver.class.getResourceAsStream("/conf/configuration.properties"));
