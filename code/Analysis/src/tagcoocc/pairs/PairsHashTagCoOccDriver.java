...
public class PairsHashTagCoOccDriver {

	private static final transient Logger LOG = LoggerFactory.getLogger(PairsHashTagCoOccDriver.class);
	...
	public static void main(String[] args) throws Exception {
		...
		properties.load(PairsHashTagCoOccDriver.class
		...
		job.setJarByClass(PairsHashTagCoOccDriver.class);
		job.setMapperClass(PairsHashTagCoOccMapper.class);
		job.setCombinerClass(PairsHashTagCoOccReducer.class);
		job.setReducerClass(PairsHashTagCoOccReducer.class);
