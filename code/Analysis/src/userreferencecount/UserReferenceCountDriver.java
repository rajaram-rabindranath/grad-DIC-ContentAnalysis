...
public class UserReferenceCountDriver {

	private static final transient Logger LOG = LoggerFactory.getLogger(UserReferenceCountDriver.class);
	...
	public static void main(String[] args) throws Exception {
		...
		properties.load(UserReferenceCountDriver.class.getResourceAsStream("/conf/configuration.properties"));
		...
		job.setJarByClass(UserReferenceCountDriver.class);
		job.setMapperClass(UserReferenceCountMapper.class);
		job.setCombinerClass(UserReferenceCountReducer.class);
		job.setReducerClass(UserReferenceCountReducer.class);
