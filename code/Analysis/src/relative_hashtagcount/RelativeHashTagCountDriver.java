...
public class RelativeHashTagCountDriver {

	private static final transient Logger LOG = LoggerFactory.getLogger(RelativeHashTagCountDriver.class);
	...
	public static void main(String[] args) throws Exception {
		...
		properties.load(RelativeHashTagCountDriver.class.getResourceAsStream("/conf/configuration.properties"));
		...
		job.setJarByClass(RelativeHashTagCountDriver.class);
		job.setMapperClass(RelativeHashTagCountMapper.class);
		job.setCombinerClass(RelativeHashTagCountReducer.class);
		job.setReducerClass(RelativeHashTagCountReducer.class);
