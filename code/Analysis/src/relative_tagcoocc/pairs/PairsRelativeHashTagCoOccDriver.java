...
public class PairsRelativeHashTagCoOccDriver {

	private static final transient Logger LOG = LoggerFactory.getLogger(PairsRelativeHashTagCoOccDriver.class);
	...
	public static void main(String[] args) throws Exception {
		...
		properties.load(PairsRelativeHashTagCoOccDriver.class.getResourceAsStream("/conf/configuration.properties"));
		...
		job.setJarByClass(PairsRelativeHashTagCoOccDriver.class);
		job.setMapperClass(PairsRelativeHashTagCoOccMapper.class);
		job.setPartitionerClass(PairsPartitioner.class);
		job.setReducerClass(PairsRelativeHashTagCoOccReducer.class);
