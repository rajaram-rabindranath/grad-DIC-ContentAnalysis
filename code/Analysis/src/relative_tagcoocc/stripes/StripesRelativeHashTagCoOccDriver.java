...
public class StripesRelativeHashTagCoOccDriver {

	private static final transient Logger LOG = LoggerFactory.getLogger(StripesRelativeHashTagCoOccDriver.class);
	...
	public static void main(String[] args) throws Exception {
		...
		properties.load(StripesRelativeHashTagCoOccDriver.class
		...
		job.setJarByClass(StripesRelativeHashTagCoOccDriver.class);
		job.setMapperClass(StripesRelativeHashTagCoOccMapper.class);
		job.setCombinerClass(StripesRelativeHashTagCoOccReducer.class);
		job.setReducerClass(StripesRelativeHashTagCoOccReducer.class);
