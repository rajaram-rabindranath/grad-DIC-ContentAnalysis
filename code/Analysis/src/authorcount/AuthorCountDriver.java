...
public class AuthorCountDriver {

	private static final transient Logger LOG = LoggerFactory.getLogger(AuthorCountDriver.class);
	...
	public static void main(String[] args) throws Exception {
		...
		properties.load(AuthorCountDriver.class.getResourceAsStream("/conf/configuration.properties"));
		...
		job.setJarByClass(AuthorCountDriver.class);
