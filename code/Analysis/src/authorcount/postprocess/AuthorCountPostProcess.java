package authorcount.postprocess;
...
public class AuthorCountPostProcess {

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		String doc = readTextFile("output/authorcount.txt");
		...
		try {
			FileWriter file = new FileWriter("authorcount.json");
