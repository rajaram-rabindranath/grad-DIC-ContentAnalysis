...
public class HashTagCountDriver {

	private static final transient Logger LOG = LoggerFactory.getLogger(HashTagCountDriver.class);
	...
	public static void main(String[] args) throws Exception {
		...
		properties.load(HashTagCountDriver.class.getResourceAsStream("/conf/configuration.properties"));
		...
		job.setJarByClass(HashTagCountDriver.class);
